...
import com.iLABWebsite.utilities.ReadConfig;
...
public class BaseClass {
	...
	{
		logger = Logger.getLogger("iLABWebsite");
	...
	{
		String num1 = RandomStringUtils.randomNumeric(2);
		String num2 =RandomStringUtils.randomNumeric(3);
		String num3 =RandomStringUtils.randomNumeric(4);
			
		String phonenumber = "0" + num1 + " " + num2 + " " + num3;
		return phonenumber;
	}
	
	public void scrollFunction(WebElement element) throws InterruptedException
	{
